...
information-processing systems was first advanced by` [`Norbert Wiener`](syntacticaltools.html#weiner) `in the early 
...
it will be at the genius level... a few months after that its power will be incalculable."`* `When we look into` [`the more distant future`](technicalimperative.html) `, according to physicist Robert Jastrow, 
...
immortal, infinitely expendable - is beginning." ...`* `There are, of course, many reputable AI experts who do not endorse the AI 
...
have` [`enormous reputations`](wrong.html) `in AI research, and their advocacy of the hypothesis is 
...
on ourselves." - Nadeau screamandshout.html/cisr/oliver@cisr.bc.ca`